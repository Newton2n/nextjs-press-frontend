      ...
      <main className="py-12 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-4xl mx-auto">
          <div className="border border-red-200 bg-red-50 dark:bg-red-950/20 dark:border-red-800 rounded-lg p-6 text-center">
            <p className="text-red-600 dark:text-red-400 font-semibold mb-4">Post not found</p>
            <Link
              href="/profile/user-1"
  ...
  return (
    <main className="py-12 px-4 sm:px-6 lg:px-8 bg-background">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-12">
          <Link href={`/profile/${post.author.id}`} className="text-primary hover:underline text-sm font-medium mb-4 inline-block">
            ← Back to Profile
          </Link>
